    ...
    <aside class="aside">
        <nav class="nav">
            ...
            <ul class="nav_list">
                ...
                <li><a href="<%=request.getContextPath()+"/admin.jsp" %>">儀錶版</a></li>
                <li><a href="<%=request.getContextPath()+"/admin1.jsp" %>">功能一</a></li>
                <li><a href="<%=request.getContextPath()+"/admin2.jsp" %>">功能二</a></li>
                <li><a href="<%=request.getContextPath()+"/admin3.jsp" %>">功能三</a></li>
                <li><a href="<%=request.getContextPath()+"/admin-class.jsp" %>">自訂功能</a></li>
                <li><a href="<%=request.getContextPath()+"/admin4.jsp" %>">功能四</a></li>
                <li><a href="<%=request.getContextPath()+"/admin5.jsp" %>">功能五</a></li>
                <li><a href="<%=request.getContextPath()+"/admin6.jsp" %>">功能六</a></li>
